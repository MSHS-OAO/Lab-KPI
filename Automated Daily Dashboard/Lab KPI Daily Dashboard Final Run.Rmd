...
### Blood Bank
#### *Blood Bank Resulted Lab Volume (Labs Resulted on `r result_date_text`)*
```{r Blood Bank: 24 hour volume lookback, echo = FALSE, warning = FALSE, message = FALSE}

if (cp_eval){
  bloodbank_vol_table <- summarize_cp_vol(x = cp_summary,
                                    lab_division = "Blood Bank")
  
  kable_cp_vol(bloodbank_vol_table)
