...
if (initial_run == TRUE) {
  ...
  repo_start_date <- as.Date("5/31/2021", format = "%m/%d/%Y")
...
for (file in file_list_sun){
  ...
  write_temporary_table_to_database_and_merge_updated(data =sun_daily_preprocessed,
                                                      key_columns = key_cols,
                                                      update_columns = update_cols,
                                                      source_table_name = "LAB_KPI_PROCESSED_DAILY_CP_DATA_SUN_ST",
                                                      destination_table_name = "LAB_KPI_PROCESSED_DAILY_CP_DATA_SUN")
